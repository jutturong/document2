      ...
      "  >
                 ...
                 <div  class="easyui-datagrid"  id="datagrid_vacation"
                       data-options="
                          ...
                          ?>
                          columns:[[
                              {  field:'name', title:'ชื่อ',align:'left', width:'auto' ,  },
                              {  field:'lastname', title:'นามสกุล',align:'left', width:'auto',   },
                              {  field:'position', title:'ตำแหน่ง',align:'left', width:'auto',   },
                          ]],
                          <?php
                          }//end if
                          ?>
                             ...
                             */
                             ...
                             ?>
                               { text:'รีโหลด', iconAlign:'top'   , iconCls:'icon-reload',handler:function(){ $('#datagrid_vacation').datagrid('reload'); }   },
                                {    
                                   text:'ตรวจสอบยกเลิกวันลา',
                                   iconCls:'icon-ok',
                                   iconAlign:'top',
                                   handler:function()
                                    {//begin function
                                          //alert('t');
                                           // $('#dia_cancel_vacation').dialog('open');
                                           //  //http://192.168.2.112/document3/index.php/welcome/json_del_vacation   
                                           //dia_del_vacation  169
                                             $('#dia_del_vacation').dialog('open');
                              ...
                              */
                              ...
                              ?>
                              {
                                   text:'ตรวจสอบวันลา/ยกเลิกวันลา',iconAlign:'top',iconCls:'icon-print',handler:function(data)
                                   {
                                             var   username='<?=$this->session->userdata("sess_us")?>';
                                             var  url='<?=base_url()?>index.php/welcome/call_name_user';
                                             $.post(url,{  username:username  },function(data)
                              ...
                              //  dataType:'text',
                                 ...
                                 data:$('#fr_vacation').serialize(),
                               }).done(function(data)
                                    {
                                            ...
                                            if(  success == 1  )
                                            {
                                                  $.messager.alert('สถานะการแก้ไขข้อมูลสำเร็จ','การแก้ไขข้อมูลสำเร็จ','info');
                                                  $('#dia_fr_vacation').dialog('close');                                                
                                            }
                                            else
                                            {
                                                  $.messager.alert('สถานะการแก้ไขข้อมูลผิดพลาด','การแก้ไขข้อมูลผิดพลาด','error');
                                                  $('#dia_fr_vacation').dialog('close');
                                            }
                                    });//end  done function 
                         } //end if
                              ...
                              $.ajax({
                               ...
                               dataType:'json',
                                 ...
                                 $.each(data,function(v,k)
                                  ...
                                  //   $('#leave').numberbox('setValue'  ,   $('#current').getValue()   );
...
<!--  ยกเลิกวันลาพักผ่อน -->
<div class="easyui-dialog"  id="dia_del_vacation"  data-options="
     
     closed:true,
     title:'ยกเลิกวันพักผ่อน',
     iconCls:'icon-man',
     
      buttons:[
             { text:'ปิด', iconCls:'icon-cancel',iconAlign:'left', size:'large', handler:function()
                       {  $('#dia_del_vacation').dialog('close');   } }
           ]

     "  style=" width:350px; height: 350px; ">
    <div class="easyui-datagrid" 
         data-options="
           url:'<?=base_url()?>index.php/welcome/json_del_vacation',
           singleSelect:true,
           rownumbers:true,
             ...
             toolbar:[
                 {
                    text:'รีโหลด',iconCls:'icon-reload', size:'large', handler:function()
                     {
                           $('#datagrid_del_vacation').datagrid('reload');
                     } //end function
                 },
                {  text:'ยกเลิกวันลา', iconCls:'icon-cancel', size:'large', iconAlign:'left', 
                     handler:function()
                     { //begin function 
                           //alert('t'); 
                           var  row=  $('#datagrid_del_vacation').datagrid('getSelected');
                           if( row )
                           {
                               var  id_vacation=row.id_vacation;
                               //alert( id_vacation );
                               if(   id_vacation > 0 )
                               {//begin if
                                      $.post('<?=base_url()?>index.php/welcome/del_vacation',{ id_vacation:id_vacation  },function(data)
                                      { // begin function
                                            ...
                                            var  success=data.success;
                                             ...
                                             if(  success  == 1 )
                                             {
                                                 $.messager.alert('ยกเลิกวันลาสำเร็จ','ยกเลิกวันลาสำเร็จ','info');
                                                 $('#datagrid_del_vacation').datagrid('reload');
                                             }
                                             else if( success == 0 )
                                             {
                                                 $.messager.alert('ยกเลิกวันลาผิดพลาด','การยกเลิกวันลาผิดพลาด','error');
                                                 $('#datagrid_del_vacation').datagrid('reload');
                                             }
                                            
                                            //datagrid_del_vacation
           ...
           columns:[[
              ...
              { field:'date_begin', title:'ลาตั้งแต่วันที่', },
              {  field:'end_date', title:'ถึงวันที่', },
              {  field:'wishes',title:'จำนวนวันลา(วัน)', },
              
           ]],
          
         
         "
         id="datagrid_del_vacation"
...
<div class="easyui-dialog"  id="dia_user_vacation"  data-options="
     ...
     toolbar:[
       ...
       {
          text:'ยกเลิกการลา',iconCls:'icon-cancel',iconAlign:'top',handler:function()
             { //begin
                     //alert('t');
                     var  row=$('#datagrid_user_vacation').datagrid('getSelected');
                     if(row)
                     {
                         ...
                         if(    id_vacation  > 0  )
                         {
                                 ...
                                 /*
                                var  url='<?=base_url()?>index.php/welcome/cancel_vacation';
                                $.post(url,{ id_vacation:id_vacation  },function(data)
                                   { //begin function
                                       ...
                                       //  alert(data);
                                         ...
                                         if( success == 11 )
                                         {
                                            $.messager.alert('ระบบได้แจ้งยกเลิกวันลาให้แล้ว','ระบบได้แจ้งยกเลิกวันลาให้แล้ว','info');
                                         }
                                         else if(   success == 1 )
                                         {
                                             $.messager.alert('ยกเลิกวันลาสำเร็จ','ระบบยกเลิกวันลาสำเร็จ','info');
                                         }
                                         else if(   success == 0 )
                                         {
                                             $.messager.alert('ยกเลิกวันลาผิดพลาด','ระบบยกเลิกวันลาผิดพลาด','info');
                                         }
                                   },'json'); //end function
                                   */
                                    ...
                                    var  url='<?=base_url()?>index.php/welcome/del_vacation';  
                                    $.post(url,{ id_vacation:id_vacation  },function(data)
                                   { //begin function
          ...
          data-options="
            ...
            columns:[[  
                     ...
                     {  field:'last_name',title:'นามสกุล'  },
                      {  field:'date_begin',title:'วันลา' },
                      {  field:'end_date',title:'ถึงวันที่' },
                      { field:'date_total_leave', title:'ลาพักผ่อนมาแล้วทั้งหมด' },
            ]]
