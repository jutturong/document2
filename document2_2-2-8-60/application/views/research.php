...
<select class="easyui-combobox" name="type_document_research" id="type_document_research" label="ประเภท" labelPosition="top" style="width:50%;height:60px">
...
<!--  ของ -->
<div style="margin-bottom:10px">
        <input class="easyui-combogrid"  id="to_research"  required="true"  name="to_research"  labelPosition="left"  style="width:80%;height:60px"
                  data-options="
