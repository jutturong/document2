...
<div class="easyui-dialog" data-options="
     ...
     buttons:[
       ...
       {  text:'แสดงข้อมูล',iconCls:'icon-reload',size:'large', handler:function()
                            {  
...
<div class="easyui-dialog"  
     data-options="
     title:'เลือกการแสดงข้อมูล,เพิ่มข้อมูล',
     closed:true,
     iconCls:'icon-man',
     size:'large',
     toolbar:[
        { text:'เพิ่มข้อมูล',iconCls:'icon-ok',size:'large',
            handler:function()
               {//function
                   // alert('t');
        ...
        { text:'แสดงข้อมูล',iconCls:'icon-reload',size:'large',
                 handler:function()
                      {//function
                          // alert('t');
                              $('#dia_detail_main').dialog('open');
        ...
        ,
        {
            text:'ค้นหาข้อมูล',iconCls:'icon-search',size:'large',handler:function()
            { 
                 alert('t'); 
     ...
     buttons:[
        { text:'ปิด',iconCls:'icon-cancel',size:'large', handler:function(){  $('#dia_select_calendar').dialog('close');  }   }
     ]
     "
     id="dia_select_calendar"  name="dia_select_calendar"
